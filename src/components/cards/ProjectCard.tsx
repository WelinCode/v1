...
export const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <div className="w-[200px] lg:w-[120px] h-[120px] lg:h-[70px] bg-slate-800 rounded flex items-center justify-center text-teal-300 text-[10px] border border-white/10 text-center p-2 shrink-0">
        {image}
      </div>
